from flask import Flask, request, render_template, jsonify ,redirect,url_for,flash # Import jsonify
import numpy as np
import pandas as pd
import pickle
import os
...
VALID_USERNAME='abhay pratap singh'
VALID_PASSWORD='6307062237'
